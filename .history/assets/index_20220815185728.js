...
listado.innerHTML += '<p>Las pizzas que tienen un id impar son: ' + impares.join() + '</p><br>';
listado.innerHTML += '<p>Las pizzas con un valor menor a $600 son: ' + menores.join() + '</p><br>';